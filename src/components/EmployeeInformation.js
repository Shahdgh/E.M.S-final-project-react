    ...
    <>
      <CDBContainer>
        <CDBCard style={{ width: "35rem" }}>
          ...
          <Image style={{ marginTop: "-5rem", textAlign:"center",alignItems:"center",marginLeft:"35%" }} className=" border " width="150px" src={profileEmployees.avatar} />
          <CDBCardBody className="d-flex flex-column align-items-center mb-4">
            ...
            <p style={{fontSize:"20px",fontWeight:"800"}} ><IoIdCardSharp />  Emplyee ID:   {profileEmployees.employeeId}</p>
            <p style={{fontSize:"20px",fontWeight:"800"}}>< MdEmail/> Emial :  {profileEmployees.email}</p>
            <p style={{fontSize:"20px",fontWeight:"800"}}><BsFillPhoneFill /> Phone Number:  {profileEmployees.phone}</p>
