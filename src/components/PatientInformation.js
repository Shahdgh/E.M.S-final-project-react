    ...
    <>
      <CDBContainer>
        <CDBCard style={{ width: "35rem", marginTop: "110px", padding: "30px" }}>
          <Image
            className="img-fluid"
            src="https://images.pexels.com/photos/3844581/pexels-photo-3844581.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940"
          />
          <Image
            style={{ marginTop: "-5rem", textAlign: "center", alignItems: "center", marginLeft: "35%" }}
            className=" border "
            width="150px"
            src={profilePatients.avatar}
          />
          <CDBCardBody className="d-flex flex-column align-items-center mb-4">
            ...
            <p style={{ fontSize: "20px", fontWeight: "800" }}>
              <MdEmail /> Email : {profilePatients.email}
            </p>
            <p style={{ fontSize: "20px", fontWeight: "800" }}>
              {" "}
              <FaAddressCard /> File Number : {profilePatients.fileNumber}
            </p>

            <p style={{ fontSize: "20px", fontWeight: "800" }}>
              <BsFillPhoneFill /> Phone {profilePatients.phone}
            </p>
            <p style={{ fontSize: "20px", fontWeight: "800" }}>
              <GiBodyHeight /> Height : {profilePatients.height}
            </p>
            <p style={{ fontSize: "20px", fontWeight: "800" }}>
              <GiWeight /> Weight : {profilePatients.weight}
            </p>
            <p style={{ fontSize: "20px", fontWeight: "800" }}> Age : {profilePatients.age}</p>
            <p style={{ fontSize: "20px", fontWeight: "800" }}>
              <RiFileList2Fill /> Disease: {profilePatients.disease}
            </p>
